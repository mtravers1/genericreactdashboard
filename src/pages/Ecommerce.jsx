...
import { earningData, SparkLineArea, ecomPieChartDat, SparklineAreaData } from '../data/dummy'
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              ...
              <p>
                ...
                <div className='mt-5'><SparkLine currentColor ={ currentColor} id="line-sparkline" type="Line" height ="80px" width="250px" data={SparklineAreaData} color="blue"/>
                </div>
                <div className='mt-10'>
